...
[System.Serializable]
[PostProcess(typeof(PEFXPlayerShowRenderer), PostProcessEvent.AfterStack, "Custom/PostEffects/ShowPlayer")]
public sealed class PEFXPlayerShow : PostProcessEffectSettings
{
...
public sealed class PEFXPlayerShowRenderer : PostProcessEffectRenderer<PEFXPlayerShow>
{
    ...
    {
        tempTex = Shader.GetGlobalTexture("_PlayerExistance");
        ...
        if (tempTex)
        {
            ...
            var maskTex = context.propertySheets.Get(Shader.Find("Custom/PostEffects/Add"));
